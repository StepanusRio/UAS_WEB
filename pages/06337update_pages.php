...
$nama = $_SESSION['nama'];
include '../modules/config/06337connection.php';
$id = $_GET['kdbrg'];
$query = "SELECT * FROM barang WHERE kdbrg = '$id'";
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="06337input_pages.php">Input Barang</a>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="../modules/function/logout.php" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="../modules/function/06337update_barang.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="kdbrg">Kode Barang</label>
                                    <input type="text" class="form-control" id="kdbrg" name="kdbrg" placeholder="Nama Barang" readonly value="<?php echo $data[0] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nmbrg">Nama Barang</label>
                                    <input type="text" class="form-control" id="nmbrg" name="nmbrg" placeholder="Harga Barang" required value="<?php echo $data[1] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="hrgbrg">Harga Barang</label>
                                    <input type="text" class="form-control" id="hrgbrg" name="hrgbrg" placeholder="Harga Barang" required value="<?php echo $data[2] ?>">
                                </div>
                                <div class="form-group">
                                    <!-- option button -->
                                ...
                                <label for="filegbr">Gambar Barang</label>
                                <div class="form-group">
                                    <img src="../assets/temp/img/barang/<?php echo $data[4] ?>" alt="<?php echo $data[0] ?>" width="100">
                                    <input type="file" class="form-control-file" id="filegbr" name="filegbr" required>
                                </div>
                                <button name="send" type="submit" class="btn btn-primary">Submit</button>
                                <button name="cancle" type="submit" class="btn btn-danger">Cancle</button>
                            </form>
                        </div>
                    </div>
                </div>
