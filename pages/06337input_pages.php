            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="../modules/function/06337input_barang.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="kdbrg">Kode Barang</label>
                                    <input type="text" class="form-control" id="kdbrg" name="kdbrg" placeholder="Nama Barang" required>
                                </div>
                                <div class="form-group">
                                    <label for="nmbrg">Nama Barang</label>
                                    <input type="text" class="form-control" id="nmbrg" name="nmbrg" placeholder="Harga Barang" required>
                                </div>
                                <div class="form-group">
                                    <label for="hrgbrg">Harga Barang</label>
                                    <input type="text" class="form-control" id="hrgbrg" name="hrgbrg" placeholder="Harga Barang" required>
                                </div>
                                <div class="form-group">
                                    <!-- option button -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" id="filegbr" name="filegbr" accept="image/*" required>
                                </div>
