        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="06337show_pages.php">Lihat Barang</a>
                    </div>
                </div>
            </li>
            <!-- Garis -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseTree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Action</h6>
                        <a class="collapse-item" href="admin_page.php">Admin</a>
                        <a class="collapse-item" href="member_page.php">Member</a>
                    </div>
                </div>
            </li>
        </ul>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales -->
                    <?php include_once '../modules/data/06337dataTables.php' ?>
                </div>
            </div>
            <!-- Footer -->
